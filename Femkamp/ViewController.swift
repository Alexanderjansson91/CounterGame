...
//        }
//        if let player = player?[currentQuestionIndex] {
//               NameLabelOne.text = player.name
//           }
//        if let player2 = player?[currentQuestionIndex] {
//                      NameLabelTwo.text = player2.name
//                  }
//
//
//    }
...
//          print(player ?? "User instance is nil")
//
//    }
//
//    func CountArray (){
